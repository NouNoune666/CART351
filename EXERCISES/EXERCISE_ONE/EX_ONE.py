...
# print(len(first_line + second_line)) # this also workds
...
# partLy = "     someone who has spent too much time    \n"
# partLyStripped = partLy.strip()
# print(partLyStripped.upper()) # your code here!
...
# print(int("19") + int("81"))
# print(int(19) + int(81)) # this also works
# #------------------------------------------------------------------------
...
# # this is nicer
# if test_var > 200:	
# 	print(f"{test_var} is greater than 200!")
# else:
# 	print(f"{test_var} is less than 200!")
# #------------------------------------------------------------------------
